...
public class UserLatestReview
{
    ...
    public static async Task<PostedReview> GetLatestReview(string userID)
    {
        await using var browser = new Browser();
        await browser.InitAsync();

        await browser.Page.GotoAsync($"https://www.google.com/maps/contrib/{userID}/reviews");
