...
pub fn get_review_embed(review_with_user: &ReviewWithUser, original: bool) -> CreateEmbed {
    ...
    CreateEmbed::default()
        ...
        .field("Stars", crate::config::get_config().star_text.repeat(review_with_user.review.stars.try_into().unwrap()), false)
        ...
        .footer(CreateEmbedFooter::new(format!("Due to caching, this review may be up to {} hours old.", crate::config::get_config().review_age_limit_hours)))
}